# iSensor FX3 Eval GUI (ADcmXL/IMU)
...
![FX3Gui Successfully Connected](https://raw.githubusercontent.com/juchong/iSensor-FX3-Eval/master/Documentation/main_window.JPG)
...
![FX3Gui SPI Configuration Window](https://raw.githubusercontent.com/juchong/iSensor-FX3-Eval/master/Documentation/spi_configuration.JPG)

## DUT Selection

The FX3 firmware and Eval GUI are designed to communicate with different ADI sensor families. Clicking the "Select DUT Type" button allows you to switch between different device families, unlocking features unique to each.  This setting is persistent throughout the Eval GUI application. 

![DUT Selection](https://raw.githubusercontent.com/juchong/iSensor-FX3-Eval/master/Documentation/select_dut.JPG)
...
![FX3Gui Register Access Window](https://raw.githubusercontent.com/juchong/iSensor-FX3-Eval/master/Documentation/register_access.JPG)
...
![ADcmXL Stream Manager Window](https://raw.githubusercontent.com/juchong/iSensor-FX3-Eval/master/Documentation/register_logging.JPG)

## ADcmXL (Burst) Real-Time Streaming

The FX3 Eval GUI provides a means of streaming register data to the PC and recording it in .csv format. This form changes based upon the sensor family and DUT type selected in the "DUT Selection" form. 
...
![ADcmXL Stream Manager Window](https://raw.githubusercontent.com/juchong/iSensor-FX3-Eval/master/Documentation/adcmxl_capture.JPG)

## IMU Burst Streaming

The FX3 Eval GUI provides a form to stream burst data from IMU products using IMU burst mode. As with other data capture forms, all data is logged to a .csv file. 

![IMU Stream Manager Window](https://raw.githubusercontent.com/juchong/iSensor-FX3-Eval/master/Documentation/imu_burst.JPG)

## Data Plotting

The FX3 Eval GUI provides a form to stream individual registers from a sensor and plot it in near real-time. Plot data can be logged to a CSV file and played back at any time.

![Data Plotting](https://raw.githubusercontent.com/juchong/iSensor-FX3-Eval/master/Documentation/data_plot.JPG)

## FFT Data Plotting

The FX3 Eval GUI provides a form to stream data from a DUT and plot the spectral results in near real-time. The plot scale, FFT size, and FFT averages can be adjusted using the form controls. Clicking on the plot window places a data marker on the plot for easy review. Plot data can be logged to a CSV file.

![Data Plotting](https://raw.githubusercontent.com/juchong/iSensor-FX3-Eval/master/Documentation/fft_plot_gui.JPG)

# PWM Setup and Pin Access

The FX3 Eval GUI provides a form to read or set pin values on the FX3 Explorer board. 

![Pin Access](https://raw.githubusercontent.com/juchong/iSensor-FX3-Eval/master/Documentation/pin_access.JPG)
...
![PWM Setup](https://raw.githubusercontent.com/juchong/iSensor-FX3-Eval/master/Documentation/pwm_setup.JPG)

# FX3 API Information

The FX3 Eval GUI allows you to load information about the current version of the FX3 API being used. This includes a link to the source code commit on GitHub.

![API Info](https://raw.githubusercontent.com/juchong/iSensor-FX3-Eval/master/Documentation/fx3_api_info.JPG)

The FX3 Eval GUI allows you to load information about the currently connected FX3 board.

![Board Info](https://raw.githubusercontent.com/juchong/iSensor-FX3-Eval/master/Documentation/board_info.JPG)
...
![Board Info](https://raw.githubusercontent.com/juchong/iSensor-FX3-Eval/master/Documentation/device_manager.JPG)
...
2. Open the FX3 Eval GUI and wait approximately 5 seconds for the bootloader to load onto flash memory. You should hear your PC disconnect and reconnect an external device several times. 
